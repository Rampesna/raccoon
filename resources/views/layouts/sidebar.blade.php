    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ Request::segment(1) === 'general' ? 'menu-item-active' : null }}" aria-haspopup="true">
                ...
                <li class="menu-item {{ Request::segment(1) === 'earnings' ? 'menu-item-open menu-item-here' : null }} menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'earnings' && Request::segment(2) === 'smm' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <!-- Licence Dynamic End -->
                            <li class="menu-item {{ Request::segment(1) === 'earnings' && Request::segment(2) === 'reports' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item {{ Request::segment(1) === 'expenses' ? 'menu-item-open menu-item-here' : null }} menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <!-- Licence Dynamic Start -->
                            <li class="menu-item {{ Request::segment(1) === 'expenses' && Request::segment(2) === 'smm' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <!-- Licence Dynamic End -->
                            <li class="menu-item {{ Request::segment(1) === 'expenses' && Request::segment(2) === 'reports' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item {{ Request::segment(1) === 'e-documents' ? 'menu-item-open menu-item-here' : null }} menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'e-documents' && Request::segment(2) === 'invoice' && Request::segment(3) === 'sent' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'e-documents' && Request::segment(2) === 'smm' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'e-documents' && Request::segment(2) === 'mm' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'e-documents' && Request::segment(2) === 'waybill' && Request::segment(3) === 'sent' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'e-documents' && Request::segment(2) === 'waybill' && Request::segment(3) === 'received' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item {{ Request::segment(1) === 'cash' ? 'menu-item-open menu-item-here' : null }} menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'cash' && Request::segment(2) === 'safe' && Request::segment(3) === 'sent' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'cash' && Request::segment(2) === 'collaterals' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item {{ Request::segment(1) === 'cash' && Request::segment(2) === 'reports' && Request::segment(3) === 'received' ? 'menu-item-active' : null }}" aria-haspopup="true">
                                <a href="#" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
