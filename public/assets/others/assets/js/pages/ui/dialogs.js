...
function showSuccessPermitMessage() {
    swal("Tamamlandı!", "İzin Talebiniz Başarıyla Oluşturuldu.", "success");
}

function showWarningPermitMessage() {
    swal("Hata!", "Reddedilmiş Tarihte Yeni İzin Talebi Oluşturulamaz!", "warning");
}

function showSuccessPaymentMessage() {
    swal("Tamamlandı!", "Ödeme Talebiniz Başarıyla Oluşturuldu.", "success");
}

function showSuccessOvertimeMessage() {
    swal("Tamamlandı!", "Fazla Mesai Talebiniz Başarıyla Oluşturuldu.", "success");
}

function showSuccessCompanyMessage() {
    swal("Tamamlandı!", "Yeni Şirket Başarıyla Oluşturuldu.", "success");
}

function showSuccessBranchMessage() {
    swal("Tamamlandı!", "Yeni Şube Başarıyla Oluşturuldu.", "success");
}

function showSuccessDepartmentMessage() {
    swal("Tamamlandı!", "Yeni Departman Başarıyla Oluşturuldu.", "success");
}

function showSuccessApellationMessage() {
    swal("Tamamlandı!", "Yeni Ünvan Başarıyla Oluşturuldu.", "success");
}

function showSuccessCompanyEditMessage() {
    swal("Tamamlandı!", "Şirket Bilgileri Başarıyla Güncellendi.", "success");
}

function showSuccessBranchEditMessage() {
    swal("Tamamlandı!", "Şube Başarıyla Güncellendi.", "success");
}

function showSuccessDepartmentEditMessage() {
    swal("Tamamlandı!", "Departman Başarıyla Güncellendi.", "success");
}

function showSuccessApellationEditMessage() {
    swal("Tamamlandı!", "Ünvan Başarıyla Güncellendi.", "success");
}

function showSuccessBranchDeleteMessage() {
    swal("Tamamlandı!", "Şube Başarıyla Silindi.", "success");
}

function showSuccessDepartmentDeleteMessage() {
    swal("Tamamlandı!", "Departman Başarıyla Silindi.", "success");
}

function showSuccessApellationDeleteMessage() {
    swal("Tamamlandı!", "Ünvan Başarıyla Silindi.", "success");
}
