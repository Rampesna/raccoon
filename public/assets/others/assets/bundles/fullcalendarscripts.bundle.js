!function (t, e) {
    ...
    var Ht = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        It = "OCAK_ŞUBAT_MART_NİSAN_MAYIS_HAZİRAN_TEMMUZ_AĞUSTOS_EYLÜL_EKİM_KASIM_ARALIK".split("_"),
        xt = "OCA_ŞUB_MAR_NİS_MAY_HAZ_TEM_AĞU_EYL_EKİ_KAS_ARA".split("_");
    ...
    var Gt = "PAZAR_PAZARTESİ_SALI_ÇARŞAMBA_PERŞEMBE_CUMA_CUMARTESİ".split("_"),
        Ut = "PAZ_PZT_SAL_ÇAR_PER_CUM_CTS".split("_"), Wt = "PZ_PT_SL_ÇR_PR_CM_CT".split("_"), jt = st, qt = st,
        Zt = st;
    ...
    var we = /^(?:(Pzt|Sal|Car|Per|Cum|Cts|Paz),?\s)?(\d{1,2})\s(Oca|Sub|Mar|Nis|May|Haz|Tem|Agu|Eyl|Eki|Kas|Ara)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
    ...
    function be(t) {
        ...
        if (h) {
            ...
            if (n = p, i = t, (e = h[1]) && Ut.indexOf(e) !== new Date(n[0], n[1], n[2]).getDay() && (D(i).weekdayMismatch = !0, i._isValid = !1, 1)) return;
    ...
    function Ke(t, e, n, i, r) {
        var o;
        return null == t ? Bt(this, i, r).year : (e > (o = Nt(t, i, r)) && (e = o), function (t, e, n, i, r) {
    ...
    function hn(t, e, n, i) {
        "boolean" == typeof t || (n = e = t, t = !1), d(e) && (n = e, e = void 0), e = e || "";
    ...
    return Vn.isValid = function () {
        ...
        n._d = new Date(E(t))
    }), m.version = "2.21.0", t = Me, m.fn = an, m.min = function () {
    ...
    return function (n) {
        ...
        function s(t) {
            ...
            return n = r(n), e = {left: 0, right: 0, top: 0, bottom: i = r(i)}, !function () {
        ...
        o.compensateScroll = function (t, e) {
            ...
            n(r), r.each(function (t, e) {
                var n = t === r.length - 1 ? s : o, i = c(e).outerHeight(!0);
            ...
            var n = t.offset(), i = s(t), r = n.left + l(t, "border-left-width") + i.left - (e ? e.left : 0),
            ...
            var n = t.offset(), i = n.left + l(t, "border-left-width") + l(t, "padding-left") - (e ? e.left : 0),
        ...
        function d(t, e, n, i, r) {
            ...
            return null == o && i && (o = i[n.field]), null == s && r && (s = r[n.field]), h(o, s) * (n.order || 1)
        }
        ...
        function p(t, e) {
            var n, i, r;
            for (n = 0; n < o.unitsDesc.length && !(1 <= (r = f(i = o.unitsDesc[n], t, e)) && D(r)); n++) ;
            return i
        }
        ...
        o.isPrimaryMouseButton = function (t) {
            ...
            return 0
        }, o.compareByFieldSpec = d, o.flexibleCompare = h, o.dayIDs = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], o.unitsDesc = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], o.diffDayTime = function (t, e) {
            return i.duration({
                days: t.clone().stripTime().diff(e.clone().stripTime(), "days"),
                ms: t.time() - e.time()
            })
        }, o.diffDay = function (t, e) {
            return i.duration({days: t.clone().stripTime().diff(e.clone().stripTime(), "days")})
        }, o.diffByUnit = function (t, e, n) {
            return i.duration(Math.round(t.diff(e, n, !0)), n)
        }, o.computeGreatestUnit = p, o.computeDurationGreatestUnit = function (t, e) {
            var n = p(t);
            return "week" === n && "object" == typeof e && e.days && (n = "day"), n
        }, o.divideRangeByDuration = function (t, e, n) {
            var i;
            return g(n) ? (e - t) / n : (i = n.asMonths(), 1 <= Math.abs(i) && D(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
        }, o.divideDurationByDuration = function (t, e) {
            var n, i;
            return g(t) || g(e) ? t / e : (n = t.asMonths(), i = e.asMonths(), 1 <= Math.abs(n) && D(n) && 1 <= Math.abs(i) && D(i) ? n / i : t.asDays() / e.asDays())
        }, o.multiplyDuration = function (t, e) {
            var n;
            return g(t) ? i.duration(t * e) : (n = t.asMonths(), 1 <= Math.abs(n) && D(n) ? i.duration({months: n * e}) : i.duration({days: t.asDays() * e}))
        ...
        o.mergeProps = function t(e, n) {
        ...
        }, o.htmlEscape = w, o.stripHtmlEntities = function (t) {
            return t.replace(/&.*?;/g, "")
            ...
            return t - e
        }, o.isInt = D, o.proxy = function (t, e) {
            var n = t[e];
            return function () {
        ...
        Object.defineProperty(o, "__esModule", {value: !0});
        var s = e(3), n = e(0), i = e(16), r = e(32), a = e(4);
        ...
        function c(t, e) {
            var n, i;
            n = o.localeOptionHash[t] || (o.localeOptionHash[t] = {}), e && (n = o.localeOptionHash[t] = r.mergeOptions([n, e])), i = h(t), s.each(u, function (t, e) {
                null == n[t] && (n[t] = e(i, n))
        ...
        }, o.locale = c, o.getMomentLocaleData = h, c("en", r.englishDefaults)
    }, function (t, e, n) {
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(4);
        e.globalDefaults = {
        ...
        var a = "\v", l = "", o = "", r = new RegExp(o + "([^" + o + "]*)" + o, "g"), u = {
            t: function (t) {
        ...
        e.formatDate = c, e.formatRange = function (t, e, n, i, r) {
            return t = s.default.parseZone(t), e = s.default.parseZone(e), function (t, e, n, i, r) {
            ...
            }(p(n = t.localeData().longDateFormat(n) || n), t, e, i || " - ", r)
        };
        var h = {};
        ...
        function f(t) {
            for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);) e[1] ? n.push.apply(n, g(e[1])) : e[2] ? n.push({maybe: f(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push.apply(n, g(e[5]));
            return n
        }
        ...
        function m(t, e) {
            var n, i, r = [], o = s.oldMomentFormat(e, t).split(a);
        ...
        var c = n(4), o = n(17), i = function () {
            ...
            return d.createFromDiff = function (t, n, i) {
                var e, r, o, s = t.end && !n.end, a = t.isAllDay() && !n.isAllDay(), l = !t.isAllDay() && n.isAllDay();
        ...
        var i = n(2), S = n(3), l = n(4), s = n(53), u = n(249), d = n(5), c = n(12), h = n(36), r = n(56), o = n(60),
            a = n(40), p = n(55), f = n(250), g = n(251), v = n(252), y = function (n) {
                ...
                return i.__extends(t, n), t.prototype.componentFootprintToSegs = function (t) {
                    ...
                    var e, n, i, r = this.rowEls.eq(t).height(), o = this.eventRenderer.rowStructs[t].tbodyEl.children();

                    function s(t, e) {
                        i = Math.max(i, S(e).outerHeight())
                    }

                    for (e = 0; e < o.length; e++) if (n = o.eq(e).removeClass("fc-limited"), i = 0, n.find("> td > :first-child").each(s), n.position().top + i > r) return e;
                    return !1
        ...
        var i = n(2), r = function (n) {
            ...
            return i.__extends(t, n), t.prototype.queue = function (t, e, n) {
                ...
                var e, n = this.q, i = !0;
                if (t.namespace && "destroy" === t.type) for (e = n.length - 1; 0 <= e; e--) switch (n[e].type) {
                    case"init":
                        i = !1;
                    case"add":
                    case"remove":
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var s = n(3), i = n(0), a = n(4), r = n(32), o = n(238), l = n(21), u = n(11), d = n(7), c = n(239), h = n(240),
            p = n(241), f = n(207), g = n(31), v = n(10), y = n(5), m = n(12), w = n(17), D = n(242), b = n(212),
            S = n(38), _ = n(49), E = n(13), M = n(37), C = n(6), T = n(51), R = function () {
                function t(t, e) {
                ...
                return t.prototype.constructed = function () {
                    ...
                    i.addClass("fc"), i.on("click.fc", "a[data-goto]", function (t) {
                        ...
                        var e = new (T.getThemeSystemClass(t.themeSystem || t.theme))(o.optionsManager),
                            n = e.getClass("widget");
                        ...
                        o.businessHourGenerator = new b.default(t.businessHours, o), o.view && o.view.set("businessHourGenerator", o.businessHourGenerator)
                    }, function () {
                    ...
                    return e || (n = v.default.utc(t.unzonedRange.endMs)), t.isAllDay ? (i.stripTime(), n && n.stripTime()) : (i = this.applyTimezone(i), n && (n = this.applyTimezone(n))), new w.default(i, n, this)
                    ...
                    var n = this, i = new D.default(this), t = this.opt("eventSources") || [], e = this.opt("events");
                    ...
                    void 0 === e && (e = !1);
                    var n = this.eventManager, i = _.default.parse(t, t.source || n.stickySource);
                    i && n.addEventDef(i, e)
                    ...
                    if (null == t) n.removeAllEventDefs(); else {
                        for (n.getEventInstances().forEach(function (t) {
                            i.push(t.toLegacy())
                        }), i = P(i, t), e = 0; e < i.length; e++) r[this.eventManager.getEventDefByUid(i[e]._id).id] = !0;
                    ...
                    i instanceof E.default && (e = i.buildInstance(), n = M.default.createFromRawProps(e, t, null), this.eventManager.mutateEventsWithId(i.id, n))
                }, t.prototype.getEventSources = function () {
                    return this.eventManager.otherSources.slice()
                }, t.prototype.getEventSourceById = function (t) {
                    return this.eventManager.getSourceById(C.default.normalizeId(t))
        ...
        var h = n(0), c = n(4), p = n(5), i = function () {
            ...
            return t.prototype.opt = function (t) {
                ...
                function d() {
                    s = t.clone().startOf(u), a = s.clone().add(n), l = new p.default(s, a)
                }

                return u || ((r = this.opt("dateIncrement")) ? (o = h.duration(r), u = o < n ? c.computeDurationGreatestUnit(o, r) : i) : u = i), n.as("days") <= 1 && this._view.isHiddenDay(s) && (s = this._view.skipHiddenDays(s, e)).startOf("day"), d(), this.trimHiddenDays(l) || (t = this._view.skipHiddenDays(t, e), d()), l
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = n(2), u = n(3), d = n(0), c = n(16), h = n(4), o = n(10), r = n(7), p = n(23), s = n(13), f = n(18),
            a = n(6), l = function (e) {
                function t() {
                    var t = null !== e && e.apply(this, arguments) || this;
                ...
                return i.__extends(t, e), t.prototype.end = function () {
                    ...
                    this.listenTo(u(document), {dragstart: this.handleDragStart, sortstart: this.handleDragStart})
                    ...
                    var r, o = this, s = this.component, a = this.view, l = function (t) {
                    ...
                    (this.dragListener = new p.default(s, {
                        interactionStart: function () {
                            o.isDragging = !0
                        }, hitOver: function (t) {
                            var e, n = !0, i = t.component.getSafeHitFootprint(t);
                            i && (r = o.computeExternalDrop(i, l)) ? (e = new f.default(r.buildInstances()), n = l.eventProps ? s.isEventInstanceGroupAllowed(e) : s.isExternalInstanceGroupAllowed(e)) : n = !1, n || (r = null, h.disableCursor()), r && s.renderDrag(s.eventRangesToEventFootprints(e.sliceRenderRanges(s.dateProfile.renderUnzonedRange, a.calendar)))
                        }, hitOut: function () {
                            r = null
                        }, hitDone: function () {
                            h.enableCursor(), s.unrenderDrag()
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), o = n(3), v = n(4), a = n(37), l = n(50), s = n(23), i = function (i) {
            function t(t, e) {
            ...
            return r.__extends(t, i), t.prototype.end = function () {
                ...
                var e, u, d = this, c = this.component, h = this.view, p = h.calendar, f = p.eventManager, n = a.el,
                    g = a.footprint.eventDef, i = a.footprint.eventInstance;
                return this.dragListener = new s.default(c, {
                    ...
                    hitOver: function (t, e, n) {
                        var i, r = !0, o = c.getSafeHitFootprint(n), s = c.getSafeHitFootprint(t);
                        o && s && (u = l ? d.computeEventStartResizeMutation(o, s, a.footprint) : d.computeEventEndResizeMutation(o, s, a.footprint)) ? (i = f.buildMutatedEventInstanceGroup(g.id, u), r = c.isEventInstanceGroupAllowed(i)) : r = !1, r ? u.isEmpty() && (u = null) : (u = null, v.disableCursor()), u && (h.hideEventsWithId(a.footprint.eventDef.id), h.renderEventResize(c.eventRangesToEventFootprints(i.sliceRenderRanges(c.dateProfile.renderUnzonedRange, p)), a))
                    },
                    hitOut: function () {
                        u = null
                    },
                    hitDone: function () {
                        h.unrenderEventResize(a), h.showEventsWithId(a.footprint.eventDef.id), v.enableCursor()
                    },
                    interactionEnd: function (t) {
                        e && d.segResizeStop(a, t), u && h.reportEventResize(i, u, n, t), d.dragListener = null
                    }
                })
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var r = n(2), y = n(4), o = n(37), u = n(50), s = n(54), m = n(23), w = n(244), i = function (i) {
            function t(t, e) {
                var n = i.call(this, t) || this;
            ...
            return r.__extends(t, i), t.prototype.end = function () {
                ...
                var e, l, u, d = this, c = this.component, h = this.view, p = h.calendar, f = p.eventManager, n = a.el,
                    g = a.footprint.eventDef, i = a.footprint.eventInstance;
                if (this.dragListener) return this.dragListener;
                var v = this.dragListener = new m.default(h, {
                    scroll: this.opt("dragScroll"), subjectEl: n, subjectCenter: !0, interactionStart: function (t) {
                        a.component = c, e = !1, (l = new w.default(a.el, {
                        ...
                        v.isTouch && !h.isEventDefSelected(g) && i && h.selectEventInstance(i), e = !0, d.eventPointing.handleMouseout(a, t), d.segDragStart(a, t), h.hideEventsWithId(a.footprint.eventDef.id)
                    }, hitOver: function (t, e, n) {
                        var i, r, o, s = !0;
                        a.hit && (n = a.hit), i = n.component.getSafeHitFootprint(n), r = t.component.getSafeHitFootprint(t), i && r && (u = d.computeEventDropMutation(i, r, g)) ? (o = f.buildMutatedEventInstanceGroup(g.id, u), s = c.isEventInstanceGroupAllowed(o)) : s = !1, s || (u = null, y.disableCursor()), u && h.renderDrag(c.eventRangesToEventFootprints(o.sliceRenderRanges(c.dateProfile.renderUnzonedRange, p)), a, v.isTouch) ? l.hide() : l.show(), e && (u = null)
                    }, hitOut: function () {
                        h.unrenderDrag(a), l.show(), u = null
                    }, hitDone: function () {
                        y.enableCursor()
                    }, interactionEnd: function (t) {
                        delete a.component, l.stop(!u, function () {
                            e && (h.unrenderDrag(a), d.segDragStop(a, t)), h.showEventsWithId(a.footprint.eventDef.id), u && h.reportEventDrop(i, u, n, t)
                        }), d.dragListener = null
                    }
                });
                return v
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i, r, o = n(2), s = n(0), l = n(3), u = n(4), d = n(39), a = n(41), c = n(227), h = n(61),
            p = function (a) {
                function t(t, e) {
                    var n = a.call(this, t, e) || this;
        ...
        (e.default = p).prototype.timeGridClass = c.default, p.prototype.dayGridClass = h.default, i = {
        ...
        var r = n(2), y = n(3), p = n(4), i = function (i) {
            ...
            return r.__extends(t, i), t.prototype.renderBgRanges = function (t) {
                ...
                var n, i, r, o, s, a, l, u = this.dayGrid.colCnt, d = this.buildSegLevels(e), c = Math.max(1, d.length),
                    h = y("<tbody/>"), p = [], f = [], g = [];
                ...
                for (n = 0; n < c; n++) {
                    if (i = d[n], r = 0, o = y("<tr/>"), p.push([]), f.push([]), g.push([]), i) for (s = 0; s < i.length; s++) {
                        for (v((a = i[s]).leftCol), l = y('<td class="fc-event-container"/>').append(a.el), a.leftCol !== a.rightCol ? l.attr("colspan", a.rightCol - a.leftCol + 1) : g[n][r] = l; r <= a.rightCol;) f[n][r] = l, p[n][r] = a, r++;
                        o.append(l)
                    }
                    v(u), this.dayGrid.bookendCells(o), h.append(o)
                }
                return {row: t, tbodyEl: h, cellMatrix: f, segMatrix: p, segLevels: d, segs: e}
